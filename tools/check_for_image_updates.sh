...
IMAGE_DIGEST1="$("$SCRIPT_DIR"/regctl manifest digest "$IMAGE_NAME1")"
readonly IMAGE_DIGEST1
IMAGE_DIGEST2="$("$SCRIPT_DIR"/regctl manifest digest "$IMAGE_NAME2")"
