...
case $(uname -m) in
  x86_64)
    MYSQL_IMAGE=container-registry.oracle.com/mysql/community-server:8.4.11
    ;;
  aarch64)
    MYSQL_IMAGE=container-registry.oracle.com/mysql/community-server:8.4.11-aarch64
    ;;
  *)
